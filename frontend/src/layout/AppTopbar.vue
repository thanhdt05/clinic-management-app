    ...
    <div class="layout-topbar-actions">
      ...
      <div class="layout-topbar-menu hidden lg:block">
        <div class="layout-topbar-menu-content flex items-center">
          <div
            class="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-surface-100 dark:bg-surface-800 border border-surface-200/80 dark:border-surface-700/80"
          >
            <div
              class="w-8 h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center font-bold text-xs select-none"
            >
            ...
            <div class="flex flex-col text-left leading-tight">
              ...
              <span
                class="text-[11px] font-medium text-surface-500 dark:text-surface-400 capitalize"
              >
                {{ auth.user?.role?.display_name ?? auth.user?.role?.name ?? 'User' }}
              </span>
            </div>
          </div>
          ...
          <button
            type="button"
            class="layout-topbar-action hover:text-red-500! hover:bg-red-50! dark:hover:bg-red-950/30!"
            title="Logout"
            @click="handleLogout"
          >
